                          ...
                          ...)
{
  ...
  if (is.null(X2))
  {
    ...
    K <- GraphKernel_Self(object$FittedForest$NodeType,
    ...
    if (!vs.train)
    {
      ...
      K <- GraphKernel_Cross(object$FittedForest$NodeType,
                        object$FittedForest$SplitVar,
                        object$FittedForest$SplitLoading,
                        object$FittedForest$SplitValue,
                        object$FittedForest$LeftNode,
      ...
      K <- GraphKernel_Train(object$FittedForest$NodeType,
                        object$FittedForest$SplitVar,
                        object$FittedForest$SplitLoading,
                        object$FittedForest$SplitValue,
                        object$FittedForest$LeftNode,
